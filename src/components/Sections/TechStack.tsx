...
const skills: SkillCategory[] = [
  ...
  },
  {
    ...
    icons: [
      ...
      {icon: '/assets/icons/expo-icon.png', label: 'Expo (React Native)'},
      ...
      {icon: '/assets/icons/jfrog-icon.png', label: 'JFrog'},
      ...
      {icon: '/assets/icons/aws-icon.png', label: 'AWS'},
  ...
  },
  {
    ...
    icons: [
      ...
      {icon: '/assets/icons/neo4j-icon.png', label: 'Neo4j'},
    ],
  },
];
